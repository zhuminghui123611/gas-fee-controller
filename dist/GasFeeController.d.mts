...
declare const GasFeeController_base: (abstract new (...args: any[]) => {
    ...
    onPollingComplete(input: GasFeePollingInput, callback: (input: GasFeePollingInput) => void): void;
}) & typeof import("@metamask/base-controller").BaseController;
/**
 * Controller that retrieves gas fee estimate data and polls for updated data on a set interval
 */
export declare class GasFeeController extends GasFeeController_base<typeof name, GasFeeState, GasFeeMessenger> {
    #private;
    private intervalId?;
